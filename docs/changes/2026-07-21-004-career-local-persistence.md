...
- [x] Windows 实际文件语义与锁竞争通过；`Volleyball.Career.EditModeTests` 为 167/167，仓库工具测试
  为 8/8，`validate_repository.py --base 22745cc` 通过。
...
0/1→1/1；最终 repository fixture 38/38。测试结果目录不进入版本控制。
