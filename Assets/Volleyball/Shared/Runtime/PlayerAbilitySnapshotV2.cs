...
{
    [DataContract]
    public sealed class PlayerAbilitySnapshotV2 : IEquatable<PlayerAbilitySnapshotV2>
    {
        ...
        [DataMember(Name = "receiveTechnique", Order = 4)] private float _receiveTechnique;
        [DataMember(Name = "setTechnique", Order = 5)] private float _setTechnique;
        [DataMember(Name = "attackTechnique", Order = 6)] private float _attackTechnique;
        [DataMember(Name = "attackPower", Order = 7)] private float _attackPower;
        [DataMember(Name = "maxAttackReach", Order = 8)] private float _maxAttackReach;

        public PlayerAbilitySnapshotV2(float mobility, float reaction, float jump, float receiveTechnique,
            float setTechnique, float attackTechnique, float attackPower, float maxAttackReach)
        {
        ...
        public bool Equals(PlayerAbilitySnapshotV2 other) => other != null &&
            _mobility.Equals(other._mobility) && _reaction.Equals(other._reaction) &&
            _jump.Equals(other._jump) && _receiveTechnique.Equals(other._receiveTechnique) &&
            _setTechnique.Equals(other._setTechnique) && _attackTechnique.Equals(other._attackTechnique) &&
            _attackPower.Equals(other._attackPower) && _maxAttackReach.Equals(other._maxAttackReach);

        public override bool Equals(object obj) => Equals(obj as PlayerAbilitySnapshotV2);
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                return (hash * 397) ^ _maxAttackReach.GetHashCode();
            }
        }
