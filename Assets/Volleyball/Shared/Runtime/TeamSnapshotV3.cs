...
{
    [DataContract]
    public sealed class TeamSnapshotV3
    {
        ...
        [DataMember(Name = "players", Order = 4)] private PlayerSnapshotV3[] _players;

        public TeamSnapshotV3(TeamId teamId, string displayName, TeamSide side, IReadOnlyList<PlayerSnapshotV3> players)
        {
        ...
        public IReadOnlyList<PlayerSnapshotV3> Players => new ReadOnlyCollection<PlayerSnapshotV3>(_players);
        ...
        private static PlayerSnapshotV3[] CopyPlayers(IReadOnlyList<PlayerSnapshotV3> players)
        {
            if (players == null) throw new ArgumentNullException(nameof(players));
            var copy = new PlayerSnapshotV3[players.Count];
