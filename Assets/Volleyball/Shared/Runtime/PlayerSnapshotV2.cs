...
{
    [DataContract]
    public sealed class PlayerSnapshotV2
    {
        ...
        [DataMember(Name = "ability", Order = 5)] private PlayerAbilitySnapshotV2 _ability;

        public PlayerSnapshotV2(PlayerId playerId, string displayName, int jerseyNumber,
            PlayerPosition position, PlayerAbilitySnapshotV2 ability)
        {
        ...
        public PlayerAbilitySnapshotV2 Ability => _ability;
