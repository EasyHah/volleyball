...
namespace VolleyballMatch.EditModeTests
{
    public sealed class SharedBoundaryTests
    {
        ...
        public void SharedAssembly_DoesNotReferenceMatchAssemblies()
        {
            ...
            Assert.That(references, Does.Not.Contain("VolleyballMatch.Match.Domain"));
            Assert.That(references, Does.Not.Contain("VolleyballMatch.Match.AI"));
            Assert.That(references, Does.Not.Contain("VolleyballMatch.Match.Presentation"));
        }
